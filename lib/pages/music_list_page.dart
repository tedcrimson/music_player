...
class MusicListPage extends BasePage {
  @override
  _MusicListPageState createState() => _MusicListPageState();

  @override
  String get name => 'Music List';
}
...
class _MusicListPageState extends State<MusicListPage> {
  List<Album> albums = [
    Album(
        artist: "Gorillaz",
        title: 'Song Machine',
        imageUrl: "https://images.genius.com/fb93904f2f5ba3f96713b3901da74106.1000x1000x1.jpg",
        tracks: [
          MediaItem(
            ...
            artist: "Gorillaz",
            duration: 361000,
            artUri: "https://images.genius.com/fb93904f2f5ba3f96713b3901da74106.1000x1000x1.jpg",
          ),
        ]),
    Album(
              ...
              children: albums
                  .map((album) => Material(
                        ...
                        child: InkWell(
                          borderRadius: BorderRadius.circular(10),
                          onTap: () {
                            Navigator.of(context).push(MaterialPageRoute(builder: (_) => AlbumPage(album)));
                          },
                          child: Column(
                            children: <Widget>[Image.network(album.imageUrl), Text(album.title), Text(album.artist)],
                          ),
                        ),
                      ))
                  .toList()),
